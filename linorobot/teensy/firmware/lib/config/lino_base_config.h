...
#define K_P 3.4 // P constant
#define K_I 0.001 // I constant
#define K_D -1.0 // D constant

//define your robot' specs here
#define MAX_RPM 333               // motor's maximum RPM
#define COUNTS_PER_REV 1385       // wheel encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.0757       // wheel's diameter in meters
#define PWM_BITS 8                // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.155  // distance between left and right wheels
